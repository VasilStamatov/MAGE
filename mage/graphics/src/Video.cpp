...
{
  // m_window.reset(new Window(std::move(_title), _monitor, _width, _height));
  m_window =
...
{
  // m_window.reset(new Window(std::move(_title), _monitor));
...
void Video::CreateWindowedWindow(std::string _title, std::int32_t _width,
                                 std::int32_t _height)
{
  // m_window.reset(new Window(std::move(_title), _width, _height));
